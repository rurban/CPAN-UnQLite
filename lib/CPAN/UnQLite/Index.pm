...
sub fetch_info {
  ...
  my $info = CPAN::UnQLite::Info->new(%wanted);
...
sub state {
  ...
  my $state = CPAN::UnQLite::State->new(%wanted);
...
sub populate {
  ...
  my $db = CPAN::UnQLite::Populate->new(%wanted);
...
CPAN::UnQLite::Index - set up or update database tables.

=head1 SYNOPSIS

 my $index = CPAN::UnQLite::Index->new(setup => 1);
 $index->index();
...
CPAN and ppm indices. The creation of the object
 ...
 my $index = CPAN::UnQLite::Index->new(%args);
...
at the beginning of L<CPAN::UnQLite::Index>. If you are
...
method of L<CPAN::UnQLite::Index> is specified,
this will get information on the state of the database
through L<CPAN::UnQLite::State>.
...
the database, through L<CPAN::UnQLite::Populate>,
...
L<CPAN::UnQLite::Info>, L<CPAN::UnQLite::State>, 
L<CPAN::UnQLite::Populate>,
and L<CPAN::UnQLite::Util>.
Development takes place on the CPAN-UnQLite project
