...
use utf8;
use CPAN::UnQLite::Util qw($mode_info);
...
sub new {
  my ($class, %args) = @_;
  $cdbi_query = CPAN::UnQLite::DBI::Search->new(%args);
...
sub query {
  ...
  my $class = 'CPAN::UnQLite::DBI::Search::' . $table;
...
package CPAN::UnQLite::Search::author;
use parent 'CPAN::UnQLite::Search';
...
package CPAN::UnQLite::Search::module;
use parent 'CPAN::UnQLite::Search';
...
package CPAN::UnQLite::Search::dist;
use parent 'CPAN::UnQLite::Search';
...
CPAN::UnQLite::Search - perform queries on the database

=head1 SYNOPSIS

  my $max_results = 200;
  my $query = CPAN::UnQLite::Search->new(db_dir => $db_dir,
                                        db_name => $db_name,
...
C<CPAN::UnQLite::Search> object is created via the C<new> method as
...
within C<CPAN::UnQLite::Search> will be used.
...
the mode and on the type of query. See L<CPAN::UnQLite::Populate>
