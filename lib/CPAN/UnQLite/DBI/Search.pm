...
package CPAN::UnQLite::DBI::Search;
...
use CPAN::UnQLite::Util qw($full_id);

package CPAN::UnQLite::DBI::Search::info;
use parent 'CPAN::UnQLite::DBI::Search';
use CPAN::UnQLite::DBI qw($dbh);

package CPAN::UnQLite::DBI::Search::chaps;
use parent 'CPAN::UnQLite::DBI::Search';
use CPAN::UnQLite::DBI qw($dbh);

package CPAN::UnQLite::DBI::Search::mods;
use parent 'CPAN::UnQLite::DBI::Search';
use CPAN::UnQLite::DBI qw($dbh);

package CPAN::UnQLite::DBI::Search::dists;
use parent 'CPAN::UnQLite::DBI::Search';
use CPAN::UnQLite::DBI qw($dbh);

package CPAN::UnQLite::DBI::Search::auths;
use parent 'CPAN::UnQLite::DBI::Search';
use CPAN::UnQLite::DBI qw($dbh);
...
use parent 'CPAN::UnQLite::DBI';
use CPAN::UnQLite::DBI qw($tables $dbh);
use CPAN::UnQLite::Util qw($full_id expand_dslip download %chaps);
...
sub fetch_and_set {
  ...
  die "Please supply a CPAN::UnQLite::Meta::* object"
    unless ($meta_obj and ref($meta_obj) =~ /^CPAN::UnQLite::META/);
...
CPAN::UnQLite::DBI::Search - DBI information for searching the CPAN::UnQLite database

=head1 DESCRIPTION

This module provides methods for L<CPAN::UnQLite::Search> for searching
the C<CPAN::UnQLite> database. There are two main methods.

=over

=item C<fetch>

This takes information from C<CPAN::UnQLite::Search> and sets up
