...
package CPAN::UnQLite::State::auths;
use parent 'CPAN::UnQLite::State';
use CPAN::UnQLite::Util qw(has_hash_data print_debug);
...
package CPAN::UnQLite::State::dists;
use parent 'CPAN::UnQLite::State';
use CPAN::UnQLite::Util qw(vcmp has_hash_data print_debug);
...
package CPAN::UnQLite::State::mods;
use parent 'CPAN::UnQLite::State';
use CPAN::UnQLite::Util qw(has_hash_data print_debug);
...
package CPAN::UnQLite::State::info;
use parent 'CPAN::UnQLite::State';
use CPAN::UnQLite::Util qw(has_hash_data print_debug);
...
CPAN::UnQLite::State - get state information on the database

=head1 DESCRIPTION

This module gets information on the current state of the
database and compares it to that obtained from the CPAN
index files from I<CPAN::UnQLite::Info> and from the
repositories from I<CPAN::UnQLite::PPM>. For each of the
