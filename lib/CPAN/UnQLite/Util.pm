...
sub vcmp {
  my ($v1, $v2) = @_;
  return CPAN::UnQLite::Version->vcmp($v1, $v2);
}
...
CPAN::UnQLite::Util - export some common data structures used by CPAN::UnQLite::*
