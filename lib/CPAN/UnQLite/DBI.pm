...
CPAN::UnQLite::DBI - DBI information for the CPAN::UnQLite database

=head1 DESCRIPTION

This module is used by L<CPAN::UnQLite::Index> and
L<CPAN::UnQLite::Search> to set up some basic database
...
L<CPAN::UnQLite::Index> and L<CPAN::UnQLite::Search>
