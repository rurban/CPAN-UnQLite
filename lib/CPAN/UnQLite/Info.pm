...
use File::Basename;
use Safe;
use CPAN::UnQLite::Util qw(vcmp print_debug);
...
CPAN::UnQLite::Info - extract information from CPAN indices
...
A C<CPAN::UnQLite::Info> object is created with

    my $info = CPAN::UnQLite::Info->new(CPAN => $cpan);
